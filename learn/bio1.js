...
why: "The community is every population of every species in the place. Add the water, " +
                   ...
                   "ecosystem." },
             checkins: [
               { id: "1.1.a", trigger: "immediate", level: 1, type: "mc", concept: "Community",
                 q: "Which term names all the living things in a pond, but not the water or sunlight?",
                 opts: ["Population", "Community", "Ecosystem", "Biome"], right: 1,
                 why: "A community includes every population of a different species. " +
                      "It stops at the living — water and sunlight are abiotic.",
                 importance: "core" },
               { id: "1.1.b", trigger: "return", level: 2, type: "sa", concept: "Biotic factor",
                 q: "Without looking back, what does \"biotic\" mean?",
                 accept: ["living", "once alive", "from something alive"],
                 why: "Biotic means living — or once alive. A fallen log is biotic " +
                      "because it came from a living tree.",
                 importance: "core" },
               { id: "1.1.c", trigger: "immediate", level: 1, type: "mc", concept: "Abiotic factor",
                 q: "Which is an abiotic factor in a pond?",
                 opts: ["Fish", "Algae", "Water temperature", "Tadpoles"], right: 2,
