...
why: "The community is every population of every species in the place. Add the water, " +
                   ...
                   "ecosystem." },
             checkins: [
               { id: "1.1.key1", type: "key-idea", label: "Key Idea",
                 content: "A community is every population of every species in a place. Add the water, temperature, and mud, and you have the ecosystem.",
                 importance: "secondary", interactive: false },
               { id: "1.1.q1", type: "quick-check", label: "Quick Check",
                 interactive: true, importance: "primary",
                 question: { q: "Which term names all the living things in a pond, but not the water or sunlight?",
                   opts: ["Population", "Community", "Ecosystem", "Biome"], right: 1, type: "mc" },
                 why: "A community includes every population of a different species. It stops at the living — water and sunlight are abiotic." },
               { id: "1.1.w1", type: "watch-out", label: "Watch Out",
                 content: "A population is one species in an area. A community is many species. They are not the same word.",
                 importance: "secondary", interactive: false },
               { id: "1.1.c1", type: "connect", label: "Connect",
                 content: "Biotic, abiotic, population, community — these ideas will matter when we study ecosystems next.",
                 importance: "tertiary", interactive: false },
               { id: "1.1.t1", type: "think", label: "Think",
                 content: "Why might removing one species affect other populations?",
                 importance: "tertiary", interactive: false },
               { id: "1.1.q2", type: "quick-check", label: "Quick Check",
                 interactive: true, importance: "primary",
                 question: { q: "Without looking back, what does biotic mean?",
                   opts: ["Non-living", "Living or once alive", "A group of species", "A habitat"], right: 1, type: "mc" },
                 why: "Biotic means living — or once alive. A fallen log is biotic because it came from a living tree.",
                 accept: ["living", "once alive", "from something alive"] },
               { id: "1.1.q3", type: "quick-check", label: "Quick Check",
                 interactive: true, importance: "primary",
                 question: { q: "Which is an abiotic factor in a pond?",
                   opts: ["Fish", "Algae", "Water temperature", "Tadpoles"], right: 2, type: "mc" },
                 why: "Water temperature is non-living. Fish, algae, and tadpoles are biotic." }
             ]
  }, {
