  ...
  L.unit("alg", 2, {
    ...
    lessons: [
      ...
      /* ============================================================== 2 */
      {
        ...
        steps: [
          { type: "learn", kicker: "Watch",
            prompt: "When an equation has brackets, multiply them out first — the distributive property from Unit 1 — and then it is an equation like any other.",
            scene: { type: "walk", rows: [
      ...
      /* ============================================================== 4 */
      {
        ...
        blurb: "Rearranging a formula is the same moves — the answer just keeps its letters.",
        mins: 8,
        v: 1,
        steps: [
          { type: "learn", kicker: "Start here",
            prompt: "A rectangle's perimeter is $P = 2l + 2w$. If you know the perimeter and the length, what is the width? You can rearrange the formula once and use it forever. The moves are the ones you already know.",
            scene: { type: "walk", rows: [
            ...
            gate: true,
            then: "The answer still has letters in it, and that is finished. You were rearranging, not finding a number." },
      ...
      /* ============================================================== 5 */
      {
        ...
        steps: [
          ...
          { type: "learn", kicker: "The one rule",
            ...
            scene: { type: "walk", rows: [
              { m: "4 < 10", say: "True: 4 really is less than 10." },
              { m: "-4 \\;?\\; -10", say: "Multiply both sides by $-1$. Is $-4$ still the smaller one?" },
              { m: "-4 > -10", say: "No — $-4$ is to the **right** of $-10$ on the number line, so it is bigger. The sign had to flip." },
              { say: "So: multiply or divide both sides by a **negative** number, and $<$ becomes $>$ (and $\\le$ becomes $\\ge$). Adding and subtracting never flip it." }] },
            gate: true },
